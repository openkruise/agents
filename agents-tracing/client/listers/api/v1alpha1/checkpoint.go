...
type CheckpointLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Checkpoint, err error)
...
type checkpointLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Checkpoint]
}

// NewCheckpointLister returns a new CheckpointLister.
func NewCheckpointLister(indexer cache.Indexer) CheckpointLister {
	return &checkpointLister{listers.New[*apiv1alpha1.Checkpoint](indexer, apiv1alpha1.Resource("checkpoint"))}
}

// Checkpoints returns an object that can list and get Checkpoints.
func (s *checkpointLister) Checkpoints(namespace string) CheckpointNamespaceLister {
	return checkpointNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Checkpoint](s.ResourceIndexer, namespace)}
}
...
type CheckpointNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Checkpoint, error)
