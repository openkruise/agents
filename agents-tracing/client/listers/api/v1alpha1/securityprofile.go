...
type SecurityProfileLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.SecurityProfile, err error)
...
type securityProfileLister struct {
	listers.ResourceIndexer[*apiv1alpha1.SecurityProfile]
}
...
func NewSecurityProfileLister(indexer cache.Indexer) SecurityProfileLister {
	return &securityProfileLister{listers.New[*apiv1alpha1.SecurityProfile](indexer, apiv1alpha1.Resource("securityprofile"))}
}

// SecurityProfiles returns an object that can list and get SecurityProfiles.
func (s *securityProfileLister) SecurityProfiles(namespace string) SecurityProfileNamespaceLister {
	return securityProfileNamespaceLister{listers.NewNamespaced[*apiv1alpha1.SecurityProfile](s.ResourceIndexer, namespace)}
}
...
type SecurityProfileNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.SecurityProfile, error)
