...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("globalsecurityprofiles"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha1().GlobalSecurityProfiles().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("globaltrafficpolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha1().GlobalTrafficPolicies().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("poolautoscalers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha1().PoolAutoscalers().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("sandboxclaims"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha1().SandboxClaims().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("trafficpolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha1().TrafficPolicies().Informer()}, nil
