...
import (
	v1alpha1 "gitlab.alibaba-inc.com/serverlessinfra/agents/api/v1alpha1"
...
func newFakeSandboxes(fake *FakeApiV1alpha1, namespace string) apiv1alpha1.SandboxInterface {
