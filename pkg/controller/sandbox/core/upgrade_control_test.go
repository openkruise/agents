...
func TestEnsureSandboxUpgraded(t *testing.T) {
	preUpgradeHook := &agentsv1alpha1.UpgradeAction{Script: "echo backup", TimeoutSeconds: 30}
	postUpgradeHook := &agentsv1alpha1.UpgradeAction{Script: "echo restore", TimeoutSeconds: 30}
	now := metav1.Now()
