...
func TestCacheSandboxCustomReconciler_Reconcile(t *testing.T) {
	...
	tests := []struct {
		...
		registerHandlers func(r *CustomReconciler[*agentsv1alpha1.Sandbox]) (updateCalled, deleteCalled *atomic.Int32)
		expectErr        bool
		expectUpdate     int32
		expectDelete     int32
	}{
		...
		},
		{
			...
			registerHandlers: func(r *CustomReconciler[*agentsv1alpha1.Sandbox]) (updateCalled, deleteCalled *atomic.Int32) {
				...
				r.AddReconcileHandlers(func(ctx context.Context, obj *agentsv1alpha1.Sandbox, notFound bool) (ctrl.Result, error) {
					if notFound {
						deleteCalled.Add(1)
					} else {
						updateCalled.Add(1)
