...
// and a warning is logged. This allows enterprise deployments to override the
// community default (e.g. switching the gateway CA Secret name).
...
//
// If no spec with the given name is registered, this call is a no-op and a
// warning is logged so that misconfigurations are visible.
