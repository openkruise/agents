...
type Infrastructure interface {
	...
	NewPoolFromTemplate(template *SandboxTemplate) SandboxPool     // Create a new SandboxPool from a template
...
type SandboxPool interface {
	// GetTemplate returns the template used to create the SandboxPool
	GetTemplate() *SandboxTemplate
