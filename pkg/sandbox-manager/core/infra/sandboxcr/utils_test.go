...
func TestFindSandboxGroup(t *testing.T) {
	...
	tests := []struct {
			...
			sbx: &v1alpha1.Sandbox{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
						consts.LabelTemplateHash: "old-hash",
					},
				},
			},
			updateHash:     testHash,
		...
		{
			name: "Pending状态的Sandbox",
			sbx: &v1alpha1.Sandbox{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
						consts.LabelTemplateHash: testHash,
					},
				},
				Status: v1alpha1.SandboxStatus{
		...
		},
		{
			...
			updateHash:     testHash,
			expectedGroup:  GroupPending,
			expectedReason: "SandboxPending",
		},
		{
			name: "Killing状态的Sandbox",
			sbx: &v1alpha1.Sandbox{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
						consts.LabelTemplateHash: testHash,
						consts.LabelSandboxState: consts.SandboxStateKilling,
					},
				},
				Status: v1alpha1.SandboxStatus{
					Phase: v1alpha1.SandboxRunning,
		...
		},
		{
			...
			sbx: &v1alpha1.Sandbox{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
						consts.LabelTemplateHash: testHash,
						consts.LabelSandboxState: "unknown-state",
					},
				},
				Status: v1alpha1.SandboxStatus{
					Phase: v1alpha1.SandboxRunning,
