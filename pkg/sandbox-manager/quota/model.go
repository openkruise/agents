...
import quotaspec "github.com/openkruise/agents/pkg/sandbox-manager/quota/spec"
...
var (
	...
	DecodeQuotaSpec       = quotaspec.DecodeQuotaSpec
	MarshalQuotaSpec      = quotaspec.MarshalQuotaSpec
)
