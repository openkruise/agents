...
func FindSandboxGroup(sbx *v1alpha1.Sandbox, updateHash string) (group, reason string) {
	...
	if sbx.Labels[v1alpha1.LabelTemplateHash] != updateHash {
	...
	default: // Running, Paused
		switch sbx.Labels[v1alpha1.LabelSandboxState] {
		...
		case v1alpha1.SandboxStateAvailable:
			return GroupAvailable, "SandboxAvailable"
		case v1alpha1.SandboxStateKilling:
